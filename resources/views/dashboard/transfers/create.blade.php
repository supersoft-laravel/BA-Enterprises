    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.transfers.store') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="row p-5">
                        <h3>{{ __('Add New Transfer') }}</h3>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('transfer_date') is-invalid @enderror" type="date"
                                ...
                                placeholder="{{ __('Enter transfer date') }}" value="{{ old('transfer_date') }}" />
                            @error('transfer_date')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Add Transfer') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
