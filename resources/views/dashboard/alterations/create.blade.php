...
@section('title', __('Create Alteration'))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.alterations.store') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="row p-5">
                        <h3>{{ __('Add New Alteration') }}</h3>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <input class="form-control @error('alteration_date') is-invalid @enderror" type="date"
                                ...
                                placeholder="{{ __('Enter alteration date') }}" value="{{ old('alteration_date') }}" />
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('alteration_details') is-invalid @enderror" id="alteration_details" name="alteration_details"
                                placeholder="{{ __('Enter alteration details...') }}">{{ old('alteration_details') }}</textarea>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Add Alteration') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
