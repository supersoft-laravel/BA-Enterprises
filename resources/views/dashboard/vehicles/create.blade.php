    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.vehicles.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row p-5">
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('make') is-invalid @enderror" type="text" id="make"
                                name="make" placeholder="{{ __('Enter make') }}" value="{{ old('make') }}" />
                            @error('make')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('model') is-invalid @enderror" type="text" id="model"
                                name="model" placeholder="{{ __('Enter model') }}" value="{{ old('model') }}" />
                            @error('model')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('year') is-invalid @enderror" type="text" id="year"
                                name="year" placeholder="{{ __('Enter year') }}" value="{{ old('year') }}" />
                            @error('year')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('chesis_number') is-invalid @enderror" type="text" id="chesis_number"
                                name="chesis_number" placeholder="{{ __('Enter chesis number') }}" value="{{ old('chesis_number') }}" />
                            @error('chesis_number')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-6">
                            ...
                            <input class="form-control @error('engine_number') is-invalid @enderror" type="text" id="engine_number"
                                name="engine_number" placeholder="{{ __('Enter engine number') }}" value="{{ old('engine_number') }}" />
                            @error('engine_number')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('wheel') is-invalid @enderror" type="text" id="wheel"
                                name="wheel" placeholder="{{ __('Enter wheel') }}" value="{{ old('wheel') }}" />
                            @error('wheel')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('weight') is-invalid @enderror" type="text" id="weight"
                                name="weight" placeholder="{{ __('Enter weight') }}" value="{{ old('weight') }}" />
                            @error('weight')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-4">
                            ...
                            <input class="form-control @error('color') is-invalid @enderror" type="text" id="color"
                                name="color" placeholder="{{ __('Enter color') }}" value="{{ old('color') }}" />
                            @error('color')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('tax_history') is-invalid @enderror" id="tax_history"
                                name="tax_history" placeholder="{{ __('Enter tax history...') }}">{{ old('tax_history') }}</textarea>
                            @error('tax_history')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4 col-md-12">
                            ...
                            <textarea class="form-control @error('penalties') is-invalid @enderror" id="penalties"
                                name="penalties" placeholder="{{ __('Enter penalties...') }}">{{ old('penalties') }}</textarea>
                            @error('penalties')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
